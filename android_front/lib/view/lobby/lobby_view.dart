...
import 'package:miku/view/lobby/invite_friend_view.dart';
import 'package:miku/view/lobby/lobby_card_widget.dart';
          ...
          children: <Widget>[
            Expanded(
              child: ListView.builder(
                itemCount: lobby.members.length + ((isHost(lobby.members) && lobby.members.length >= lobby.game.minPlayers) ? 1 : 0),
