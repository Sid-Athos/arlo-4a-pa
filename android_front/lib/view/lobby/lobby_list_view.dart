...
import 'package:miku/view/ranking/ranking_game_view.dart';
...
class _LobbyListViewState extends State<LobbyListView> {
  _LobbyListViewState(
      {required this.game, required this.channel, required this.lobby});
          ...
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => RankingGameView(game: game)),
              );
            },
            icon: const Icon(
              Icons.emoji_events,
